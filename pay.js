...
*/
    var a = this || self;
    var b = ["google", "payments", "api", "EnableGpayNewButtonAsset"]
      , c = window || a;
    b[0]in c || "undefined" == typeof c.execScript || c.execScript("var " + b[0]);
    for (var d; b.length && (d = b.shift()); )
        b.length ? c = c[d] && c[d] !== Object.prototype[d] ? c[d] : c[d] = {} : c[d] = !0;
...
*/
    ...
    }, p = ca(this), da = "function" === typeof Symbol && "symbol" === typeof Symbol("x"), r = {}, ea = {}, t = function(a, b) {
        var c = ea[b];
        if (null == c)
            return a[b];
        c = a[c];
    ...
    u("Promise", function(a) {
        ...
        ;
        e.prototype.Bc = function(f) {
            if (f === this)
                this.tb(new TypeError("A Promise cannot resolve to itself"));
        ...
        e.prototype.Ac = function(f) {
            ...
            "function" == typeof h ? this.Fc(h, f) : this.Mb(f)
        }
        ;
        e.prototype.tb = function(f) {
            this.ac(2, f)
        }
        ;
        e.prototype.Mb = function(f) {
            this.ac(1, f)
        }
        ;
        e.prototype.ac = function(f, h) {
            if (0 != this.qa)
                throw Error("Cannot settle(" + f + ", " + h + "): Promise already settled in state" + this.qa);
            this.qa = f;
            this.X = h;
            2 === this.qa && this.Cc();
            this.nc()
        ...
        e.prototype.Cc = function() {
            ...
            d(function() {
                if (f.tc()) {
                    var h = p.console;
                    "undefined" !== typeof h && h.error(f.X)
                }
            }, 1)
        }
        ;
        ...
        e.prototype.nc = function() {
            if (null != this.pa) {
                for (var f = 0; f < this.pa.length; ++f)
                    g.Db(this.pa[f]);
                this.pa = null
            }
        }
        ;
        var g = new b;
        e.prototype.Ec = function(f) {
            var h = this.gb();
            f.Oa(h.resolve, h.reject)
        }
        ;
        e.prototype.Fc = function(f, h) {
            var k = this.gb();
            try {
        ...
        e.prototype.then = function(f, h) {
            function k(z, G) {
                return "function" == typeof z ? function(ma) {
                    try {
                        l(z(ma))
                    } catch (U) {
                        q(U)
        ...
        e.prototype.Oa = function(f, h) {
            function k() {
                ...
                case 2:
                    ...
                    break;
                default:
                    throw Error("Unexpected state: " + l.qa);
                }
            }
            var l = this;
            null == this.pa ? g.Db(k) : this.pa.push(k);
            this.Pb = !0
        }
        ;
        e.resolve = c;
        ...
        e.race = function(f) {
            return new e(function(h, k) {
                for (var l = ha(f), q = l.next(); !q.done; q = l.next())
                    c(q.value).Oa(h, k)
            }
            )
        }
    ...
    u("WeakMap", function(a) {
        ...
        var d = "$jscomp_hidden_" + Math.random()
          , e = 0
          , g = function(f) {
            this.xa = (e += Math.random() + 1).toString();
            if (f) {
                f = ha(f);
        ...
        g.prototype.get = function(f) {
            return c(f) && v(f, d) ? f[d][this.xa] : void 0
        }
        ;
        g.prototype.has = function(f) {
            return c(f) && v(f, d) && v(f[d], this.xa)
        }
        ;
        g.prototype.delete = function(f) {
            return c(f) && v(f, d) && v(f[d], this.xa) ? delete f[d][this.xa] : !1
        }
        ;
        return g
    }, "es6");
    u("Map", function(a) {
        ...
        c.prototype.delete = function(h) {
            ...
            h.list.length || delete this.fa[h.id],
            h.u.S.next = h.u.next,
            h.u.next.S = h.u.S,
            h.u.head = null,
            this.size--,
        ...
        c.prototype.forEach = function(h, k) {
            for (var l = t(this, "entries").call(this), q; !(q = l.next()).done; )
                q = q.value,
        ...
        var d = function(h, k) {
            var l = k && typeof k;
            "object" == l || "function" == l ? b.has(k) ? l = b.get(k) : (l = "" + ++f,
            b.set(k, l)) : l = "p_" + k;
            var q = h.fa[l];
            if (q && v(h.fa, l))
    ...
    u("Array.prototype.includes", function(a) {
        return a ? a : function(b, c) {
            ...
            for (0 > c && (c = Math.max(c + e, 0)); c < e; c++) {
                var g = d[c];
                if (g === b || t(Object, "is").call(Object, g, b))
                    return !0
            }
            return !1
        }
    ...
    var ka = da && "function" == typeof t(Object, "assign") ? t(Object, "assign") : function(a, b) {
    ...
    var B = function(a, b, c) {
      ...
      , xa = function(a, b, c) {
        "number" !== typeof a && va("Expected number but got %s: %s.", [y(a), a], b, Array.prototype.slice.call(arguments, 2));
        return a
    }
      , ya = function(a, b, c) {
        "string" !== typeof a && va("Expected string but got %s: %s.", [y(a), a], b, Array.prototype.slice.call(arguments, 2))
    }
      , za = function(a, b, c) {
        A(a) || va("Expected object but got %s: %s.", [y(a), a], b, Array.prototype.slice.call(arguments, 2))
    };
    var C = function(a, b) {
        this.yb = a === Aa && b || "";
        this.fc = Ba
    ...
    C.prototype.toString = function() {
        return "Const{" + this.yb + "}"
    }
    ;
    var D = function(a) {
        if (a instanceof C && a.constructor === C && a.fc === Ba)
            return a.yb;
...
*/
    var Ra = "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz".split("");
    function Sa(a) {
    ...
    function Ua(a, b) {
        if ("object" !== typeof b || null === b)
            return a;
        for (var c in b)
            b.hasOwnProperty(c) && void 0 !== b[c] && (null == b[c] ? a[c] = null : null == a[c] || "object" !== typeof a[c] || "object" !== typeof b[c] || Array.isArray(b[c]) || Array.isArray(a[c]) ? a[c] = b[c] : Ua(a[c], b[c]));
        return a
    }
    function Va(a) {
        var b = 0, c;
    ...
    function H(a) {
        console.error("DEVELOPER_ERROR in " + a.ba + ": " + a.errorMessage)
    }
    ...
    eb[" "] = function() {}
    ;
    var fb = I("Trident") || I("MSIE")
      , gb = I("Gecko") && !(-1 != db().toLowerCase().indexOf("webkit") && !I("Edge")) && !(I("Trident") || I("MSIE")) && !I("Edge")
      , hb = -1 != db().toLowerCase().indexOf("webkit") && !I("Edge");
    function ib(a, b) {
        for (var c in a)
    ...
    var pb = function(a) {
        if (a instanceof ob && a.constructor === ob)
            return a.rb;
        wa("expected object of type TrustedResourceUrl, got '" + a + "' of type " + y(a));
      ...
      , tb = function(a, b) {
        ...
        a = c.replace(rb, function(d, e) {
            ...
            d = b[e];
            return d instanceof C ? D(d) : encodeURIComponent(String(d))
        });
        return sb(a)
    }
      , rb = /%{(\w+)}/g
    ...
    ;
    var vb = function(a) {
        if (a instanceof J && a.constructor === J)
            return a.qb;
        wa("expected object of type SafeUrl, got '" + a + "' of type " + y(a));
    ...
    var yb = function(a) {
        if (a instanceof K && a.constructor === K)
            return a.pb;
        wa("expected object of type SafeHtml, got '" + a + "' of type " + y(a));
        return "type_error:SafeHtml"
    }
      , Ab = function(a) {
        a instanceof K || (a = "object" == typeof a && a.za ? a.wa() : String(a),
        cb.test(a) && (-1 != a.indexOf("&") && (a = a.replace(Xa, "&amp;")),
      ...
      , Cb = function(a) {
        var b = Ab(Bb)
          , c = []
          , d = function(e) {
            Array.isArray(e) ? e.forEach(d) : (e = Ab(e),
            c.push(yb(e).toString()))
        };
        a.forEach(d);
        return zb(c.join(yb(b).toString()))
    }
      , Db = function(a) {
      ...
      , Bb = new K(w.trustedTypes && w.trustedTypes.emptyHTML || "",xb)
      , Eb = zb("<br>");
    var Fb = {
        MATH: !0,
        SCRIPT: !0,
      ...
      , Hb = function(a, b) {
        if (a.tagName && Fb[a.tagName.toUpperCase()])
      ...
      , Ib = function(a, b, c, d) {
        a instanceof J || a instanceof J || (a = "object" == typeof a && a.za ? a.wa() : String(a),
        B(wb.test(a), "%s does not match the safe URL pattern", a) || (a = "about:invalid#zClosurez"),
        a = new J(a,ub));
        b = b || w;
        c = c instanceof C ? D(c) : c || "";
    ...
    var Lb = function(a) {
        var b = Array.prototype.map.call(arguments, D).join("")
          , c = E("Constant HTML string, that gets turned into a Node later, so it will be automatically balanced.");
        ya(D(c), "must provide justification");
        ...
        d = c.createElement(d);
        fb ? (Hb(d, Db(Eb, b)),
        d.removeChild(B(d.firstChild))) : Hb(d, b);
        if (1 == d.childNodes.length)
            b = d.removeChild(B(d.firstChild));
        else
    ...
    var Mb = function(a) {
        if (a.ga && "function" == typeof a.ga)
            return a.ga();
        if ("undefined" !== typeof r.Map && a instanceof r.Map || "undefined" !== typeof Set && a instanceof Set)
      ...
      , Nb = function(a) {
        if (a.hb && "function" == typeof a.hb)
            return a.hb();
        if (!a.ga || "function" != typeof a.ga) {
            if ("undefined" !== typeof r.Map && a instanceof r.Map)
      ...
      , Ob = function(a, b, c) {
        if (a.forEach && "function" == typeof a.forEach)
            ...
            for (var d = Nb(a), e = Mb(a), g = e.length, f = 0; f < g; f++)
    ...
    var L = function(a) {
        ...
        if (a instanceof L) {
            ...
            a && (b = String(a).match(Pb)) ? (this.F = !1,
            Sb(this, b[1] || "", !0),
            a = b[2] || "",
            M(this),
            this.ka = Vb(a),
            ...
            a = b[7] || "",
            M(this),
            this.L = Vb(a)) : (this.F = !1,
            this.H = new N(null,this.F))
    };
    L.prototype.toString = function() {
        ...
        if (c || "file" == b)
            a.push("//"),
            (b = this.ka) && a.push(Wb(b, Xb, !0), "@"),
            a.push(encodeURIComponent(String(c)).replace(/%25([0-9a-fA-F]{2})/g, "%$1")),
            c = this.j,
            null != c && a.push(":", String(c));
        if (c = this.M)
            this.N && "/" != c.charAt(0) && a.push("/"),
            a.push(Wb(c, "/" == c.charAt(0) ? Yb : Zb, !0));
        (c = this.H.toString()) && a.push("?", c);
        (c = this.L) && a.push("#", Wb(c, $b));
        return a.join("")
    }
    ;
    L.prototype.resolve = function(a) {
        ...
        if (c)
            ...
            if (".." == e || "." == e)
                ...
                for (var g = [], f = 0; f < e.length; ) {
                    var h = e[f++];
                    "." == h ? d && f == e.length && g.push("") : ".." == h ? ((1 < g.length || 1 == g.length && "" != g[0]) && g.pop(),
                    d && f == e.length && g.push("")) : (g.push(h),
                    d = !0)
                }
                d = g.join("/")
            } else
        ...
        c ? (M(b),
        b.M = d) : c = "" !== a.H.toString();
        c ? Ub(b, a.H.clone()) : c = !!a.L;
        c && (a = a.L,
        M(b),
        b.L = a);
        return b
    ...
    var Sb = function(a, b, c) {
      ...
      , Ub = function(a, b, c) {
        M(a);
        b instanceof N ? (a.H = b,
        a.H.wb(a.F)) : (c || (b = Wb(b, ac)),
        a.H = new N(b,a.F))
    };
    ...
    var Vb = function(a, b) {
      ...
      , Wb = function(a, b, c) {
        return "string" === typeof a ? (a = encodeURI(a).replace(b, cc),
    ...
    N.prototype.remove = function(a) {
        O(this);
        a = dc(this, a);
        return this.h.has(a) ? (this.D = null,
        this.A = xa(this.A) - this.h.get(a).length,
        this.h.delete(a)) : !1
    }
    ;
    ...
    m.ga = function(a) {
        ...
        var b = [];
        if ("string" === typeof a)
            ec(this, a) && (b = b.concat(this.h.get(dc(this, a))));
        else {
    ...
    m.set = function(a, b) {
        ...
        this.D = null;
        a = dc(this, a);
        ec(this, a) && (this.A = xa(this.A) - this.h.get(a).length);
        this.h.set(a, [b]);
        this.A = xa(this.A) + 1;
        return this
    }
    ...
    N.prototype.wb = function(a) {
        ...
        this.h.forEach(function(b, c) {
            ...
            0 < b.length)) {
                ...
                var g = b.length;
                if (0 < g) {
                    for (var f = Array(g), h = 0; h < g; h++)
                        f[h] = b[h];
                    g = f
                } else
                    g = [];
                e.call(c, d, g);
                this.A = xa(this.A) + b.length
            }
        }, this));
        this.F = a
    }
    ...
    function mc(a) {
        ...
        hc.push(a.buttonRootNode || document));
        var b = nc(a)
          , c = document.createElement("button");
        oc(c);
        c.setAttribute("class", (-1658203989 === Va(ic) ? "gpay-button" : "") + " gpay-card-info-container " + b);
        var d = document.createElement("div");
        d.setAttribute("class", pc(a) ? "\n    gpay-card-info-animation-container new_style black\n    " : P(a) ? "\n    gpay-card-info-animation-container white\n    " : "\n    gpay-card-info-animation-container black\n    ");
        b = document.createElement("div");
        b.setAttribute("class", "gpay-card-info-placeholder-container");
        var e = document.createElement("div");
        e.setAttribute("class", pc(a) ? "\n    gpay-card-info-animation-gpay-logo new_style black\n    " : P(a) ? "\n    gpay-card-info-animation-gpay-logo white\n    " : "\n    gpay-card-info-animation-gpay-logo black\n    ");
        var g = Lb(P(a) ? Ma : pc(a) ? Oa : Na)
          , f = document.createElement("div");
        f.setAttribute("class", "gpay-card-info-animated-progress-bar-container");
        var h = document.createElement("div");
        h.setAttribute("class", pc(a) ? "\n    gpay-card-info-animated-progress-bar-new_style\n    " : "\n    gpay-card-info-animated-progress-bar\n    ");
        var k = document.createElement("div");
        k.setAttribute("class", pc(a) ? "\n    gpay-card-info-animated-progress-bar-indicator-new_style\n    " : "\n    gpay-card-info-animated-progress-bar-indicator\n    ");
        h.appendChild(k);
        b.appendChild(e);
        "fill" !== a.buttonSizeMode ? b.appendChild(g) : (e = Lb(P(a) ? Pa : Qa),
        ...
        bc(b, "buttonColor", a.buttonColor);
        bc(b, "browserLocale", rc(a.buttonLocale));
        bc(b, "buttonSizeMode", a.buttonSizeMode);
        bc(b, "enableGpayNewButtonAsset", google.payments.api.EnableGpayNewButtonAsset || !1);
        void 0 !== a.allowedPaymentMethods && bc(b, "allowedPaymentMethods", JSON.stringify(a.allowedPaymentMethods));
        l.src = b.toString();
        l.onload = function() {
            l.classList.add("gpay-card-info-iframe-fade-in");
            d.classList.add("gpay-card-info-animation-container-fade-out")
        }
        ;
        a.onClick && c.addEventListener("click", a.onClick);
        qc(c);
        c.appendChild(l);
        b = document.createElement("div");
        f = pc(a) ? "\n    gpay-card-info-container-fill-new-style\n    " : "\n    gpay-card-info-container-fill\n    ";
        "fill" === a.buttonSizeMode && b.setAttribute("class", f);
        b.appendChild(c);
        return b
    }
    function qc(a) {
    ...
    function nc(a) {
        ...
        return !P(a) && google.payments.api.EnableGpayNewButtonAsset ? b + " " + c + " new_style " + rc(a.buttonLocale) : b + " " + c + " " + rc(a.buttonLocale)
    }
    function P(a) {
        return "white" == a.buttonColor
    }
    function rc(a, b) {
        var c = null != navigator.language ? navigator.language.substring(0, 5) : "en"
          , d = (a || c || "en").substring(0, 5)
          , e = google.payments.api.EnableGpayNewButtonAsset ? La : Ka;
        if (d in e.buy)
            return d;
        d !== c && (void 0 === b ? 0 : b) && H({
            ba: "createButton",
    ...
    function pc(a) {
        return google.payments.api.EnableGpayNewButtonAsset && !P(a)
    }
    ;var sc = function() {
        this.Ic = Q.contentWindow
    };
    sc.prototype.postMessage = function(a, b) {
        this.Ic.postMessage(a, b)
    }
    ;
    ...
    ;
    var vc = new uc("OFF",Infinity), wc = new uc("WARNING",900), xc = new uc("CONFIG",700), yc = function() {
        this.Pa = 0;
        this.clear()
    }, zc;
    yc.prototype.clear = function() {
        this.Hb = Array(this.Pa);
        this.Ib = -1;
        this.Ob = !1
    }
    ;
    var Ac = function(a, b, c) {
        this.reset(a || vc, b, c, void 0, void 0)
    };
...
*/
    var Ic = []
      , Jc = function(a) {
        var b;
        if (b = Gc(Hc(), "safevalues").rc) {
            var c = "A URL with content '" + a + "' was sanitized away."
              , d = wc;
            if (a = b)
                if (a = b && d) {
                    a = d.value;
                    var e = b ? Cc(Gc(Hc(), b.getName())) : vc;
                    a = a >= e.value
                }
            if (a) {
                d = d || vc;
    ...
    ;var Lc = {
      ...
      , S = function(a) {
        if (Qc && Mc) {
            a = t(Object, "assign").call(Object, {
                buyFlowActivityMode: Pc,
                googleTransactionId: Nc,
                originTimeMs: Oc
            }, a);
            if ("CANARY" == R)
    ...
    (function() {
        if (!Q) {
            ...
            Kc(Q, tb(E(("CANARY" == R ? "https://ibfe-canary.corp" : "https://pay") + ("PREPROD" == R ? "-preprod.sandbox" : "SANDBOX" == R ? ".sandbox" : "") + ".google.com/gp/p/ui/payframe?origin=%{windowOrigin}&mid=%{merchantId}"), {
    ...
    var Zc = function(a, b, c, d) {
        return r.Promise.resolve(r.Promise.race([Wc("PAYMENT_AUTHORIZATION", c), b.onPaymentAuthorized(a)])).then(function(e) {
            return d("paymentAuthorizationResponse", e)
        }, function(e) {
            Yc("REQUEST_TIMEOUT" === e.message, 27, 2);
            return d("paymentAuthorizationResponse", Xc(e, "PAYMENT_AUTHORIZATION"))
        })
    }
      , $c = function(a, b, c, d) {
        return r.Promise.resolve(r.Promise.race([Wc(a.callbackTrigger in Ca ? Ca[a.callbackTrigger] : "UNKNOWN_INTENT", c), b.onPaymentDataChanged(a)])).then(function(e) {
            return d("paymentDataCallbackResponse", e)
        }, function(e) {
            Yc("REQUEST_TIMEOUT" === e.message, 26, Lc[a.callbackTrigger]);
            return d("paymentDataCallbackResponse", Xc(e, a.callbackTrigger || "UNKNOWN_INTENT"))
        })
    };
    var bd = function() {
    ...
    bd.prototype.show = function(a) {
        this.Xa = a || null;
        this.Lb.body.appendChild(this.O);
        ad(this.O, {
            display: "block",
            opacity: 0
        });
    ...
    var dd = function(a) {
        a.Xa = null;
        a.O.parentElement && cd(a.O, {
            opacity: 0
        }).then(function() {
            ad(a.O, {
                display: "none"
            });
            a.Lb.body.removeChild(a.O)
        })
    };
    function ad(a, b) {
        for (var c in b)
    ...
    function cd(a, b) {
        ...
        return (new r.Promise(function(e) {
            c.setTimeout(function() {
                c.setTimeout(e, 300);
                ad(a, t(Object, "assign").call(Object, {
    ...
    ;var ed = function(a) {
        this.s = a;
        this.nb = this.ob = this.B = this.ea = null;
        this.ia = 3E4
    };
    m = ed.prototype;
    m.sb = function(a) {
    ...
    m.prefetchPaymentData = function(a) {
        fd(a, this.s, a.transactionInfo.currencyCode, a.transactionInfo.totalPrice)
    }
    ;
    ...
    var fd = function(a, b, c, d) {
      ...
      , gd = function(a, b) {
        b = fd(b, a.s, b.transactionInfo && b.transactionInfo.currencyCode || void 0, b.transactionInfo && b.transactionInfo.totalPrice || void 0);
        b.onpaymentmethodchange = function(c) {
            var d = new Vc;
            d = c.methodDetails.callbackTrigger ? $c(c.methodDetails, a.B, a.ia, d.Sb) : Zc(c.methodDetails, a.B, a.ia, d.Sb);
            c.updateWith(d)
        }
        ;
    ...
    function kd(a, b) {
        return 2 <= a.apiVersion && (a = jd(a)) && t(a, "includes").call(a, b) ? !0 : !1
    }
    function ld() {
    ...
    function md(a) {
        if (a.environment && !(n = t(Object, "values").call(Object, Da),
    ...
    function nd(a) {
        ...
        } else if (!a.allowedPaymentMethods || !Array.isArray(a.allowedPaymentMethods) || 0 == a.allowedPaymentMethods.length || !a.allowedPaymentMethods.every(qd))
            return "allowedPaymentMethods must be set to an array containing 'CARD' and/or 'TOKENIZED_CARD'!";
        return null
    }
    function qd(a) {
        return (n = t(Object, "values").call(Object, Ea),
        t(n, "includes")).call(n, a)
    }
    function pd(a) {
        return (n = t(Object, "values").call(Object, Fa),
        t(n, "includes")).call(n, a)
    }
    function rd(a) {
        if (!a)
        ...
        if (a.transactionInfo)
            if (a.transactionInfo.currencyCode) {
                if (!a.transactionInfo.totalPriceStatus || !(n = t(Object, "values").call(Object, Ga),
    ...
    function jd(a) {
        return a.allowedPaymentMethods && (a = sd(a, "CARD")) && a.parameters ? a.parameters.allowedAuthMethods : null
    }
    function sd(a, b) {
    ...
    ;var vd = function(a, b) {
        ...
        if (!c) {
            var d = Jb();
            c = d;
            void 0 === a.style[d] && (d = (hb ? "Webkit" : gb ? "Moz" : fb ? "ms" : null) + Kb(d),
    ...
    var wd = function(a, b) {
        ...
        b = b.map(function(c) {
            if ("string" === typeof c)
                return c;
            za(c, "Expected css3 property to be an object.");
            var d = c.xc + " " + c.duration + "s " + c.timing + " " + c.delay + "s";
            B(c.xc && "number" === typeof c.duration && c.timing && "number" === typeof c.delay, "Unexpected css3 property value: %s", d);
            return d
        });
        vd(a, b.join(","))
    };
    ...
    var zd = function() {
        ...
        try {
            w.addEventListener("test", function() {}, b),
            w.removeEventListener("test", function() {}, b)
        } catch (c) {}
        return a
    }();
    var Bd = function(a, b) {
        ...
        if (a) {
            ...
            this.screenY = d.screenY || 0) : (this.offsetX = hb || void 0 !== a.offsetX ? a.offsetX : a.layerX,
            ...
            this.state = a.state;
            this.va = a;
            a.defaultPrevented && Bd.Ga.preventDefault.call(this)
        }
    };
    ra(Bd, yd);
    var Ad = tc({
    ...
    Gd.prototype.add = function(a, b, c, d, e) {
        ...
        var f = Hd(a, b, d, e);
        -1 < f ? (b = a[f],
        c || (b.Na = !1)) : (b = new Ed(b,this.src,g,!!d,e),
        b.Na = c,
        a.push(b));
        return b
    }
    ...
    Gd.prototype.ib = function(a, b, c, d) {
        a = this.v[a.toString()];
        var e = -1;
        a && (e = Hd(a, b, c, d));
        return -1 < e ? a[e] : null
    ...
    Gd.prototype.hasListener = function(a, b) {
        var c = void 0 !== a
          , d = c ? a.toString() : ""
          , e = void 0 !== b;
        return ib(this.v, function(g) {
            for (var f = 0; f < g.length; ++f)
                if (!(c && g[f].type != d || e && g[f].capture != b))
                    return !0;
            return !1
        })
    }
    ...
    var Hd = function(a, b, c, d) {
        for (var e = 0; e < a.length; ++e) {
            var g = a[e];
            if (!g.Ea && g.listener == b && g.capture == !!c && g.Sa == d)
                return e
        }
        return -1
    };
    var Jd = "closure_lm_" + (1E6 * Math.random() | 0)
      ...
      , Nd = function(a, b, c, d, e) {
        if (d && d.once)
            ...
            c = Od(c),
            a && a[Cd] ? (d = A(d) ? !!d.capture : !!d,
            Pd(a),
            a.J.add(String(b), c, !1, d, e)) : Qd(a, b, c, !1, d, e)
    }
      , Qd = function(a, b, c, d, e, g) {
        if (!b)
            throw Error("Invalid event type");
        var f = A(e) ? !!e.capture : !!e
          , h = Rd(a);
        h || (a[Jd] = h = new Gd(a));
        c = h.add(b, c, d, f, g);
        if (!c.proxy) {
      ...
      , Md = function(a, b, c, d, e) {
        if (Array.isArray(b))
            ...
            c = Od(c),
            a && a[Cd] ? a.J.add(String(b), c, !0, A(d) ? !!d.capture : !!d, e) : Qd(a, b, c, !0, d, e)
    }
      , Vd = function(a, b, c, d, e) {
        if (Array.isArray(b))
            ...
            d = A(d) ? !!d.capture : !!d,
            c = Od(c),
            a && a[Cd] ? a.J.remove(String(b), c, d, e) : a && (a = Rd(a)) && (b = a.ib(b, c, d, e)) && Wd(b)
    }
      , Wd = function(a) {
    ...
    T.prototype.dispatchEvent = function(a) {
        ...
        e = !0;
        if (c)
            for (var g = c.length - 1; !a.Da && 0 <= g; g--) {
                var f = a.currentTarget = c[g];
                e = Yd(f, d, !0, a) && e
            }
        a.Da || (f = a.currentTarget = b,
        e = Yd(f, d, !0, a) && e,
        a.Da || (e = Yd(f, d, !1, a) && e));
        if (c)
            for (g = 0; !a.Da && g < c.length; g++)
                f = a.currentTarget = c[g],
                e = Yd(f, d, !1, a) && e;
        return e
    }
    ;
    ...
    T.prototype.hasListener = function(a, b) {
        return this.J.hasListener(void 0 !== a ? String(a) : void 0, b)
    }
    ;
    var Pd = function(a) {
        B(a.J, "Event target is not initialized. Did you call the superclass (goog.events.EventTarget) constructor?")
    };
    var Zd = function(a, b) {
        T.call(this);
        this.Ta = a || 1;
        this.Ia = b || w;
        this.Gb = qa(this.Hc, this);
        this.Qb = Date.now()
    };
    ra(Zd, T);
    m = Zd.prototype;
    ...
    m.setInterval = function(a) {
        this.Ta = a;
        this.K && this.enabled ? (this.stop(),
        this.start()) : this.K && this.stop()
    }
    ;
    m.Hc = function() {
        if (this.enabled) {
            var a = Date.now() - this.Qb;
            0 < a && a < .8 * this.Ta ? this.K = this.Ia.setTimeout(this.Gb, this.Ta - a) : (this.K && (this.Ia.clearTimeout(this.K),
            this.K = null),
    ...
    m.start = function() {
        this.enabled = !0;
        this.K || (this.K = this.Ia.setTimeout(this.Gb, this.Ta),
        this.Qb = Date.now())
    }
    ;
    m.stop = function() {
        this.enabled = !1;
        this.K && (this.Ia.clearTimeout(this.K),
        this.K = null)
    }
    ;
    m.ua = function() {
...
*/
    ...
    function ce(a) {
        ...
        void 0 !== a.lb && (b.originVerified = a.lb);
    ...
    var V = function(a, b, c) {
        ...
        this.Ab = null;
        this.Bb = !1;
        this.V = this.Va = this.W = this.j = null;
        this.Fb = this.oc.bind(this)
    };
    V.prototype.connect = function(a) {
        if (this.W)
            throw Error("already connected");
        this.W = a;
        this.g.addEventListener("message", this.Fb)
    }
    ;
    V.prototype.disconnect = function() {
        ...
        this.j && (ge(this.j),
        this.j = null),
        this.g.removeEventListener("message", this.Fb),
        this.V)) {
            for (var a in this.V) {
                var b = this.V[a];
                b.port1 && ge(b.port1);
    ...
    ;
    var he = function(a) {
        a.W && !a.Ab && (a.Ab = "function" == typeof a.zb ? a.zb() : a.zb);
        return a.Ab
    }
      , ie = function(a) {
        if (null == a.C)
      ...
      , le = function(a, b) {
        var c = null;
        a.Bb && "function" == typeof a.g.MessageChannel && (c = new a.g.MessageChannel);
        ...
        if (!this.zc || he(this) == a.source) {
            ...
            if (b && "__ACTIVITIES__" == b.sentinel) {
                ...
                if (!this.j || "connect" == c || "start" == c) {
                    ...
                    d == this.C && this.oa(c, b, a)
                }
            }
        }
    }
    ;
    V.prototype.oa = function(a, b, c) {
        "connect" == a ? (this.j && (ge(this.j),
        this.j = null),
        this.Bb = b && b.acceptsChannel || !1,
        this.W(a, b)) : "start" == a ? ((c = c.ports && c.ports[0]) && ke(this, c),
        this.W(a, b)) : "msg" == a ? null != this.Va && null != b && this.Va(b) : "cnget" == a ? (b = b.name || "",
        a = me(this, b),
    ...
    var ne = function(a, b, c) {
        ...
        this.ab = b;
        this.La = c || null;
        this.g = this.ya.ownerDocument.defaultView;
        this.C = Qb(pb(b).toString());
        this.ta = null;
    ...
    m.connect = function() {
        ...
        this.m.connect(this.oa.bind(this));
        a = this.ya;
        b = this.ab;
        if (!A(a) || !A(a) || !A(a) || 1 !== a.nodeType || a.namespaceURI && "http://www.w3.org/1999/xhtml" !== a.namespaceURI || a.tagName.toUpperCase() !== "IFRAME".toString()) {
            var c = "IFRAME".toString() + "; got: ";
            if (A(a))
                try {
                    var d = a.constructor.displayName || a.constructor.name || Object.prototype.toString.call(a)
                } catch (e) {
                    d = "<object could not be stringified>"
                }
            else
                d = void 0 === a ? "undefined" : null === a ? "null" : typeof a;
            wa("Argument is not an HTML Element with tag name " + (c + d))
        }
        a.src = pb(b).toString();
        return this.fb
    }
    ...
    ;
    m.oa = function(a, b) {
        "connect" == a ? (le(this.m, this.La),
        this.ta()) : "result" == a ? this.I && (a = b.code,
        b = new $d(a,"failed" == a ? Error(b.data || "") : b.data,"iframe",ie(this.m),!0,!0),
        de(this.g, b, this.I),
        this.I = null,
        je(this.m, "close"),
        this.disconnect()) : "ready" == a ? this.Ya && (this.Ya(),
        this.Ya = null) : "resize" == a && (this.Xb = b.height,
        this.Tb && this.Tb(this.Xb))
    }
    ;
    var oe = function(a, b, c, d, e, g) {
        ...
        this.I = null;
        this.Za = new r.Promise(function(k) {
            f.I = k
        }
        );
    ...
    var pe = function(a) {
        ...
        if (!a.ha.ud) {
            var d = ce({
                requestId: a.yc,
                Zb: a.ha.Zb || ae(a.g.location.href),
                ic: a.La
            });
            c = c + (-1 == c.indexOf("#") ? "#" : "&") + encodeURIComponent("__WA__") + "=" + encodeURIComponent(d)
        }
        d = a.vc;
        "_top" != D(d) && ee(a.g) && (d = E("_top"));
        try {
            var e = Ib(c, a.g, d, b)
        } catch (g) {}
        if (!e && "_top" != D(d) && !a.ha.td) {
            d = E("_top");
            try {
                e = Ib(c, a.g, d)
            } catch (g) {}
        ...
        e ? (a.Z = e,
        "_top" != D(d) && re(a)) : se(a, Error("failed to open window"));
        return a.Za.catch(function() {})
    }
      , qe = function(a) {
        var b = a.g.screen
        ...
        a.ha.width && (d = Math.min(a.ha.width, c));
        a.ha.height && (e = Math.min(a.ha.height, f));
      ...
      , re = function(a) {
        ...
        a.R.start();
        a.m = new V(a.g,a.Z,null);
        a.m.connect(a.oa.bind(a))
    }
      , te = function(a, b) {
        if (!a.Z || a.Z.closed)
            a.R && (a.R.stop(),
    ...
    oe.prototype.X = function(a, b) {
        if (this.I) {
            var c = this.m.isConnected();
            a = new $d(a,b,"popup",c ? ie(this.m) : Qb(this.ab),c,c);
            de(this.g, a, this.I);
            this.I = null
        }
    ...
    ;
    oe.prototype.oa = function(a, b) {
        var c = this;
        "connect" == a ? (le(this.m, this.La),
        this.ta()) : "result" == a ? (a = b.code,
        this.X(a, "failed" == a ? Error(b.data || "") : b.data)) : "check" == a && this.g.setTimeout(function() {
            return te(c)
        }, 200)
    }
    ;
    ...
    ue.prototype.Ka = function() {
        var a = this
          , b = new $d(this.lc,this.fa,"redirect",this.C,this.Gc,!1);
        return new r.Promise(function(c) {
            de(a.g, b, c)
        }
        )
    ...
    ve.prototype.open = function(a, b, c, d, e) {
        return {
            vd: xe(this, a, b, c, d, e).Ra()
        }
    }
    ;
    var ye = function(a, b, c, d, e) {
        var g = xe(a, "GPAY", b, c, d, e);
        return g.fb.then(function() {
            return g
        })
    };
    ve.prototype.Aa = function(a, b) {
        var c = this.ub[a];
        c || (c = [],
        this.ub[a] = c);
        c.push(b);
            ...
            try {
                ...
                if (e) {
                    ...
                    if (g && g.requestId == a) {
                        ...
                        var q = f;
                        q = q || "";
                        if (q != d.location.hash && d.history && d.history.replaceState)
                            try {
                        ...
                        var x = g.code
                          , z = g.data
                          , G = g.origin
                          , ma = d.document.referrer && Qb(d.document.referrer);
                        c = new ue(d,x,z,G,G == ma)
                    } else
                        c = null
                } else
                    c = null
    ...
    ;
    var xe = function(a, b, c, d, e, g) {
        var f = new oe(a.g,b,c,d,e,g);
    ...
    var W = function(a, b, c, d) {
        ...
        this.Kb = this.j = null;
        this.Wb = d || null;
        this.nb = this.ob = this.B = this.Fa = null;
        this.ia = 3E4;
    ...
    W.prototype.Aa = function(a) {
        this.ea || (this.ea = a,
        this.Cb.Aa("GPAY", this.uc.bind(this)))
    }
    ;
    W.prototype.uc = function(a) {
        var b = this;
        dd(this.Nb);
        this.ea(a.Ka().then(function(c) {
            if ("TIN" != b.s && c.origin != Be(b))
    ...
    W.prototype.isReadyToPay = function(a) {
        ...
        return new r.Promise(function(c, d) {
            if (id(a))
                ...
                if ((0 < e.indexOf("GSA/") && 0 < e.indexOf("Safari") || g || f || h || k || l) && !b.bb)
                    c({
                        result: !1
                    });
                else {
                    ...
                    if (google.payments.api.ReadyToPayAdditionalBrowsers) {
                        ...
                        f = 0 < e.indexOf("OPT") || 0 < e.indexOf("UCBrowser")
                    }
                    var q = 0 < e.indexOf("Chrome") || 0 < e.indexOf("Firefox") || 0 < e.indexOf("Safari") || f || g;
                    q && 2 <= a.apiVersion && a.existingPaymentMethodRequired ? (a.environment = b.s,
                    Sc(a, 6, ["isReadyToPayResponse", "isReadyToPayError"], function(x) {
                        var z = {
                            result: q
                        };
                        ...
                        }) : z.paymentMethodPresent = "READY_TO_PAY" == x.data.isReadyToPayResponse);
                        c(z)
                    })) : c({
                        result: q
                    })
    ...
    ;
    W.prototype.prefetchPaymentData = function(a) {
        if (this.bb) {
            this.sa(a);
            var b = Ee(this, a)
    ...
    ;
    W.prototype.loadPaymentData = function(a) {
        var b = this;
        ...
        if (this.bb) {
            ...
            var e = function(g) {
                g.preventDefault();
                g = c;
                g.container.parentNode && (b.Kb(r.Promise.reject({
                    errorCode: "CANCELED"
                })),
                He(g.container, g.iframe),
                b.j && b.j.disconnect());
            ...
            this.ea(r.Promise.race([d, a]))
        } else
            return Pc = a.forceRedirect ? 3 : 2,
            ye(this.Cb, "TIN" == this.s ? "/ui/pay" : Be(this) + "/gp/p/ui/pay", a.forceRedirect ? E("_top") : E("gp-js-popup"), a, Ie(a)).then(function(g) {
                var f = new Vc;
                b.Nb.show(g && g.Ra());
                ...
                g.onMessage(function(h) {
                    "partialPaymentDataCallback" == h.type ? b.ob = $c(h.data, b.B, b.ia, f.Ua).then(function(k) {
                        return g.message(k)
                    }) : "fullPaymentDataCallback" == h.type && (b.nb = Zc(h.data, b.B, b.ia, f.Ua).then(function(k) {
                        g.message(k)
                    }))
                })
            })
    ...
    var Be = function(a) {
      ...
      , De = function(a) {
        ...
        a.Wb && (b += "?rk=" + encodeURIComponent(a.Wb));
        return b
    }
      , Je = function(a, b) {
        var c = window.location.origin
          , d = E("https://pay.google.com/gp/p/ui/pay?origin=%{origin}&coordination_token=%{coordinationToken}");
        if ("CANARY" == a)
            d = E("https://ibfe-canary.corp.google.com/gp/p/ui/pay?origin=%{origin}&coordination_token=%{coordinationToken}");
        else if ("SANDBOX" == a || "PREPROD" == a)
            d = E("https://pay" + ("PREPROD" == a ? "-preprod" : "") + ".sandbox.google.com/gp/p/ui/pay?origin=%{origin}&coordination_token=%{coordinationToken}");
        return tb(d, {
      ...
      , Ee = function(a, b) {
        ...
        c = b.iframe;
        d = b.container;
        d.addEventListener("click", qa(a.kc, a, b));
    ...
    var Ge = function(a, b, c, d) {
        ...
        setTimeout(function() {
            ...
            setTimeout(function() {
                a.xb = !0;
                a.Fa && (Ke(c, a.Fa.transition),
                c.height = a.Fa.height,
                a.Fa = null)
            }, 250)
        }, 1)
    }
      ...
      , Fe = function(a, b, c, d) {
        ...
        var g;
        e = Je(a.s, e);
        return we(c, e, d).then(function(f) {
            a.j = f;
            var h = new Vc;
            f.onMessage(function(k) {
                "partialPaymentDataCallback" == k.type ? a.ob = $c(k.data, a.B, a.ia, h.Ua).then(function(l) {
                    return f.message(l)
                }) : "fullPaymentDataCallback" == k.type ? a.nb = Zc(k.data, a.B, a.ia, h.Ua).then(function(l) {
                    return f.message(l)
                }) : "resize" == k.type && (a.xb ? (g || (g = Date.now()),
                Date.now() < g + 250 ? Ke(c, k.transition + ", height 250ms") : Ke(c, k.transition),
                c.height = k.height) : a.Fa = {
                    height: k.height,
    ...
    var Le = "actions.google.com amp-actions.sandbox.google.com amp-actions-staging.sandbox.google.com amp-actions-autopush.sandbox.google.com payments.developers.google.com payments.google.com".split(" "), Y = function(a, b, c, d) {
        ...
        Me || (Me = -1 != Le.indexOf(window.location.hostname) && a.i && a.i.googleTransactionId ? a.i.googleTransactionId : Sa(this.s));
        this.G = a;
        this.Jb = a.merchantInfo && a.merchantInfo.merchantId ? a.merchantInfo.merchantId : "";
        a.paymentDataCallback && (a.paymentDataCallbacks = {
            onPaymentDataChanged: a.paymentDataCallback
        });
        this.B = null;
        this.l = new Ne(a,c);
        this.aa = new W(this.s,c,d,a.i && a.i.redirectKey);
        this.la = 5;
        this.U = null;
        b = this.l.mode;
        this.na = 5 === b || 4 === b ? new ed(this.s) : this.aa;
        a.paymentDataCallbacks && (this.B = a.paymentDataCallbacks,
        this.na.sb(a.paymentDataCallbacks),
        this.aa.sb(a.paymentDataCallbacks));
        this.aa.Aa(this.Ub.bind(this));
        this.na.Aa(this.Ub.bind(this));
        Pc = b;
        Nc = Me;
        S({
            eventType: 9,
        ...
        return a.G.merchantInfo && a.G.merchantInfo.softwareInfo ? a.G.merchantInfo.softwareInfo : null
    };
    Y.prototype.isReadyToPay = function(a) {
        var b = this;
        if (a) {
            var c = {};
            this.G.environment && (c.environment = this.G.environment);
            this.G.merchantInfo && (c.merchantInfo = this.G.merchantInfo);
            this.G.i && (c.i = this.G.i);
        ...
        var g = ld() || nd(a);
        if (g)
            return new r.Promise(function(l, q) {
                H({
                    ba: "isReadyToPay",
                    errorMessage: g
                });
        ...
        var f = [].concat(ia(this.l.o))
          , h = Oe(this, a, f);
        if (a.activityModeRequired) {
            var k = null;
            return Pe.then(function(l) {
                k = l;
                return h
            }, function() {
                k = !1;
    ...
    var Qe = function(a, b, c, d, e) {
      ...
      , Oe = function(a, b, c) {
        if (google.payments.api.DisableNativeReadyToPayCheckForPaymentHandler ? 4 === a.l.mode && !Se(b) : a.l.Ha && !Se(b)) {
            if (2 <= b.apiVersion)
                return Te(a, b, c);
            var d = a.aa.isReadyToPay(b)
              , e = a.na.isReadyToPay(b);
            if (id(b) && !a.l.ra)
                return c.push(6),
                e;
            c.push(7);
      ...
      , Te = function(a, b, c) {
        ...
        if (kd(b, "CRYPTOGRAM_3DS")) {
            ...
            for (var g = 0; g < e.allowedPaymentMethods.length; g++)
                "CARD" == e.allowedPaymentMethods[g].type && (e.allowedPaymentMethods[g].parameters.allowedAuthMethods = ["CRYPTOGRAM_3DS"]);
            c.push(8);
            e = a.na.isReadyToPay(e)
        }
        var f = d;
        kd(b, "PAN_ONLY") && (c.push(9),
        f = a.aa.isReadyToPay(b));
        return a.l.ra ? (c.push(99),
        e.then(function() {
            return f
        })) : e.then(function(h) {
    ...
    m.prefetchPaymentData = function(a) {
        var b = ld() || rd(a);
        b ? H({
            ba: "prefetchPaymentData",
            errorMessage: b
        }) : (this.sa(a),
        this.l.Ha && !Se(a) ? this.na.prefetchPaymentData(a) : this.aa.prefetchPaymentData(a))
    }
    ;
    ...
    m.loadPaymentData = function(a) {
        ...
        Pc = this.l.mode;
        if (e)
            this.kb(new r.Promise(function(k, l) {
                S({
                    eventType: 1,
                    error: 2,
                    buyFlowMode: b.la,
    ...
    m.ma = function(a) {
        ...
        c = this.Jb;
        a = void 0 === a ? {} : a;
        (n = t(Object, "values").call(Object, Ha),
        t(n, "includes")).call(n, a.buttonType) || (a.buttonType = "long");
        (n = t(Object, "values").call(Object, Ja),
        t(n, "includes")).call(n, a.buttonSizeMode) || (a.buttonSizeMode = "static");
        if (!(n = t(Object, "values").call(Object, Ia),
        t(n, "includes")).call(n, a.buttonColor) || google.payments.api.EnableGpayNewButtonAsset)
            a.buttonColor = "black";
        b = a;
        c = c && t(lc, "includes").call(lc, Va(c));
        d = t(jc, "includes").call(jc, Va(ic));
        var e = t(kc, "includes").call(kc, Va(ic));
        if (!(google.payments.api.EnableDynamicGpayButtonForTesting || google.payments.api.EnableDynamicGpayButton || d) || c || e || "long" !== b.buttonType && "buy" !== b.buttonType) {
            ...
            "fill" === a.buttonSizeMode && (google.payments.api.EnableGpayNewButtonAsset ? c.setAttribute("class", "gpay-button-fill-new-style") : c.setAttribute("class", "gpay-button-fill"));
            c.appendChild(b);
            a = c
        } else
            a = mc(a);
    ...
    m.sa = function(a) {
        ...
        this.G.i && this.G.i.firstPartyMerchantIdentifier && (a.i.firstPartyMerchantIdentifier = this.G.i.firstPartyMerchantIdentifier)
    }
    ;
    Y.prototype.createButton = Y.prototype.ma;
    Y.prototype.loadPaymentData = Y.prototype.loadPaymentData;
    Y.prototype.notifyAvailableOffers = Y.prototype.notifyAvailableOffers;
    Y.prototype.prefetchPaymentData = Y.prototype.prefetchPaymentData;
    Y.prototype.isReadyToPay = Y.prototype.isReadyToPay;
    var Pe = null
      , Ve = null
      , Ne = function(a, b) {
        b = void 0 === b ? !1 : b;
        ...
        this.eb.paymentDataCallbacks && this.o.push(97),
        a = !0) : (this.o.push(36),
        a = !1));
        this.ra = a;
        this.Ha = We(this);
        this.mode = 2;
        b ? (this.o = [38],
        this.mode = 1) : this.Ha && this.ra ? this.mode = 5 : this.Ha && (this.mode = 4);
      ...
      , Ue = function(a, b, c) {
        ...
        2) : !Ve && (a.ra || google.payments.api.UseCanMakePaymentForFallbackOnMobile && a.Ha) ? (c.push(40),
        2) : a.ra && b.swg ? (c.push(5),
        2) : a.mode
    }
      , We = function(a) {
    ...
    la("google.payments.api.PaymentsAsyncClient", Y);
    Y.prototype.isReadyToPay = Y.prototype.isReadyToPay;
    Y.prototype.prefetchPaymentData = Y.prototype.prefetchPaymentData;
    Y.prototype.loadPaymentData = Y.prototype.loadPaymentData;
    Y.prototype.createButton = Y.prototype.ma;
    ...
    var Z = function(a, b) {
        a = void 0 === a ? {} : a;
        this.sc = Ta({}, window.gpayMerchantIdFromUrl ? {
            merchantInfo: {
                merchantId: window.gpayMerchantIdFromUrl
            }
        } : {}, window.gpayInitParams, a);
        this.Ma = new Y(this.sc,this.wc.bind(this),b);
        this.Ba = null
    };
    m = Z.prototype;
    m.wc = function(a) {
    ...
    ;
    m.isReadyToPay = function(a) {
        return this.Ma.isReadyToPay(a)
    }
    ;
    m.prefetchPaymentData = function(a) {
        this.Ma.prefetchPaymentData(a)
    }
    ;
    m.notifyAvailableOffers = function() {}
    ;
    ...
    ;
    Z.prototype.createButton = Z.prototype.ma;
    ...
    la("google.payments.api.PaymentsClient", Z);
    Z.prototype.isReadyToPay = Z.prototype.isReadyToPay;
    Z.prototype.prefetchPaymentData = Z.prototype.prefetchPaymentData;
    Z.prototype.loadPaymentData = Z.prototype.loadPaymentData;
    Z.prototype.createButton = Z.prototype.ma;
    ...
    if (google.payments.api.UseCanMakePaymentResultFromPayjs) {
        try {
            Pe = (new PaymentRequest([{
                supportedMethods: [connect-src],
                data: Z {
                    apiVersion: 2,
                    apiVersionMinor: 1,
